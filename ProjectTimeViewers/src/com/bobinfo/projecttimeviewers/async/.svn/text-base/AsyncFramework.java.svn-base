 ...
 * @param <Result> 结果
 */
public abstract class AsyncFramework<Params, Progress, Result> implements
		Cancelable {
	 ...
	 */
	public final AsyncFramework<Params, Progress, Result> execute(
			Params... params) {
	 ...
	 *             {@link AsyncTask.Status#FINISHED}.
	 */
	public final AsyncFramework<Params, Progress, Result> executeOnExecutor(
	...
	@Override
	public void cancel() {
		Log.d(this.getClass().getSimpleName(), "Cancel process!");
		mFuture.cancel(true);
	}
